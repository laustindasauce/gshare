...
const ClientGalleryPreviewHandler = (props: Props) => {
...
ClientGalleryPreviewHandler.Layout = DefaultLayout;

export default ClientGalleryPreviewHandler;
...
export const getServerSideProps: GetServerSideProps = async (
  ...
  try {
    const res = await api.getGalleryByIdServerSide(id, token);
